---
name: ccshut
description: Use when the injected comment rule does not settle it — a doc comment on a public symbol, a comment already in the code that might be worth keeping, or a deletion that could lose the only record of something.
---
