---
name: bequiet
description: Use when the injected bequiet rule does not settle it — shaping a question with options, judging whether a word is one this user has met, or an answer that keeps growing.
---
